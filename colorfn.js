...
/**
 * IsArrayish
 * The MIT License (MIT) Copyright (c) 2015 JD Ballard
 * https://github.com/qix-/node-is-arrayish/
 */

const isArrayish = function (obj) {
...
/**
 * Simple-swizzle
 * The MIT License (MIT) Copyright (c) 2015 Josh Junon
 * https://github.com/qix-/node-simple-swizzle/
 */

const swizzle = (function () {
...
const colorConvert = (function () {
  const cssKeywords = colorNames
  ...
  for (const model of Object.keys(conversions)) {
  ...
  conversions.rgb.ansi16 = function (args, saturation = null) {
    const [r, g, b] = args
    let value = saturation === null ? conversions.rgb.hsv(args)[2] : saturation // Hsv -> ansi16 optimization
  ...
  conversions.gray.hsl = function (args) {
    return [0, 0, args[0]]
  }

  conversions.gray.hsv = conversions.gray.hsl
